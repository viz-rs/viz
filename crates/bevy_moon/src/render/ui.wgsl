#define_import_path bevy_moon::ui;
...
const BORDER_LEFT: u32 = 512u;
const BORDER_TOP: u32 = 1024u;
const BORDER_RIGHT: u32 = 2048u;
const BORDER_BOTTOM: u32 = 4096u;
...
fn draw_uinode_border(
    ...
    let fw = fwidth(border_distance);
    let t = 1.0 - smoothstep(-fw, fw, border_distance); 
#else
...
fn draw_uinode_background(
    ...
    let fw = fwidth(internal_distance);
    let t = 1.0 - smoothstep(-fw, fw, internal_distance); 
#else
